...
const CourseDetails = () => {
  ...
  const toggleSection = (index) => {
    setOpenSections((prev) => ({
        ...
        [index]: !prev[index], // Toggle the state of the specific index
    }));
};
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left'>
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
                  ...
                  <p className='text-gray-500' >{courseData.enrolledStudents.length} {courseData.enrolledStudents.lenght > 1 ? "students" : "student"}</p>
        </div>
        <p className='text-sm'>Course by <span className="text-blue-600 underline">Ap anushka</span></p>
